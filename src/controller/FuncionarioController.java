...
public class FuncionarioController extends BD {
	 ...
	 * @param cbOrdenar
	 */
	public FuncionarioController(JTextField tfPesquisa, JComboBox cbOrdenar, JTextField tfCpf) {
		...
		if (getConnection()) {
			try {
				...
				while (rs.next()) {
					...
					sb.append(" ");
					sb.append("NOME: " + rs.getString("FUNCIONARIO"));
					sb.append(" ");
				...
				JOptionPane.showMessageDialog(null, sb.toString(), "Lista de funcionarios",
